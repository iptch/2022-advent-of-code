...
public class Task2 {
    public static void main(String[] args) {
        ...
        Directory directory = directories.stream().sorted().findFirst().get();

        // to be deleted = 2558312
        System.out.println("Size of directory: " + directory.sum);
    ...
    public static class Directory implements Comparable<Directory> {
        public Directory() {
        }
